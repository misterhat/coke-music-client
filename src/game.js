...
const Appearance = require('./components/appearance');
const Chat = require('./components/chat');
const Entry = require('./states/entry');
const Inventory = require('./components/inventory');
const Login = require('./states/login');
const Navigation = require('./components/navigation');
const ObjectSettings = require('./components/object-settings');
const Register = require('./states/register');
